...
public class PostNewClothingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_post_new_clothing, container, false);
        usernameFootwear = view.findViewById(R.id.usernameFootwear);
        Bundle bundle = this.getArguments();
        usernameFootwear.setText(this.getArguments().getString("USER"));


        descriptionFootwear = view.findViewById(R.id.descriptionClothing);
        brandNameFootwear = view.findViewById(R.id.brandClothing);
        itemNameFootwear = view.findViewById(R.id.itemNameClothing);
        priceFootwear = view.findViewById(R.id.priceClothing);

        PostNewFootwearButton = view.findViewById(R.id.PostNewClothingButton);
                    ...
                    try {
                        if (connection != null) {
                            if (usernameFootwear1.isEmpty()){
                                ...
                                String sqlInsertFootwear = "INSERT INTO Clothing_Table (Description, Brand, ItemName, Price) " +
